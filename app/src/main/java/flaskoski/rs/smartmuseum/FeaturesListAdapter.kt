...
class FeaturesListAdapter(private val featuresList: List<Feature>, private val context: Context) : RecyclerView.Adapter<FeaturesListAdapter.ItemViewHolder>() {
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): FeaturesListAdapter.ItemViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.feature_item, p0, false)
        return FeaturesListAdapter.ItemViewHolder(view)
    }
    ...
    override fun onBindViewHolder(p0: FeaturesListAdapter.ItemViewHolder, p1: Int) {
        val rate = fun(v : View) {
